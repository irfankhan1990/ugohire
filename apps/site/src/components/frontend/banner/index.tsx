...
const Banner = ({ totalCount }: { totalCount: any }) => {
  ...
  return (
    ...
    >
      <div className="absolute w-full h-full left-0 top-0 z-2 bg-black/50"></div>
        ...
        <div className="w-10/12 m-auto z-4 relative">
          <div className="text-center">
            ...
            <p className="text-lg font-normal text-white leading-8">
              A simple, cutting-edge, state-of-the-art, artificial intelligence
...
<div className="mx-auto">
      <div className="conatiner-text">
        <p className="text-animation h-12 sm:h-18 lg:h-24 text-2xl sm:text-5xl lg:text-8xl font-bold uppercase animate-text space-x-4 md:space-x-8 flex items-center">
          <span className="block text-black">AI</span>
      <span className="block text-cyan-500 pb-2">+</span>
      <span className="block text-yellow-600">DIY</span>
      <span className="block text-cyan-500 pb-2">=</span>
      <span className="block text-cyan-500">JOBS</span>
      <span className="block text-pink-600">4</span>
      <span className="block text-green-600">U</span>
      <span className="block">{" "}</span>
          ...
          <div className="search-wrapper mt-10 p-2 rounded-2xl mb-10 bg-themePrimary/50">
            <form onSubmit={handleSubmit(OnSubmitHandler)}>
              <div className="bg-white overflow-hidden rounded-xl  md:grid gap-7 lg:gap-10 grid-cols-10 items-center">
...
const typeTextString = () => {
  return <p className="bg-green-500">Hello World</p>
}