...
const EditJob = () => {
  ...
  const onSubmit = async (data: any) => {
    ...
    const hourlyrateMaximumValue = hourlyrateMaximum || 0;
    const hourlyrateMinimumValue = hourlyrateMinimum || 0;
    const salaryMaximumValue = salaryMaximum || 0;
    const salaryMinimumValue = salaryMinimum || 0;
    ...
    formData.append("hourlyrateMaximum", hourlyrateMaximumValue); // return number
    formData.append("hourlyrateMinimum", hourlyrateMinimumValue); // return number
    ...
    formData.append("salaryMaximum", salaryMaximumValue); // return number
    formData.append("salaryMinimum", salaryMinimumValue); // return number
